...
class CancelledServiceDetailPage extends StatefulWidget {
  const CancelledServiceDetailPage(
  ...
  @override
  StateMVC<CancelledServiceDetailPage> createState() =>
      _CancelledServiceDetailPageState();
}

class _CancelledServiceDetailPageState
    extends StateMVC<CancelledServiceDetailPage> {
  bool isLoading = true;
